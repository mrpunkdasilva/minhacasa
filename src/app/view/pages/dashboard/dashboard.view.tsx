...
function SummaryCard({ title, value, subtitle, color }: { title: string, value: number, subtitle: string, color: 'zinc' | 'emerald' | 'amber' | 'rose' }) {
  const colorMap = {
  ...
  return (
    <div className={`bg-zinc-900 border ${colorMap[color]} rounded-lg p-6 flex flex-col justify-between h-32`}>
