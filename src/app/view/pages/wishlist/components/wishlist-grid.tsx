          ...
          >
            <div>
              <div className="flex justify-between items-start mb-4">
                ...
                <span className={`text-[10px] px-2 py-0.5 rounded font-bold uppercase ${priorityStyles[item.priority]}`}>
                  {item.priority}
                </span>
              </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-[10px] font-mono text-zinc-500">
                  <span>{item.savedAmount.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}</span>
                  <span>Faltam {(item.price - item.savedAmount).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}</span>
                </div>
              </div>
