...
export default function MarketAnalysis() {
  const marketExpenses = invoicesMock.filter(
    (inv) => inv.category === Category.FOOD,
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 flex flex-col justify-between h-32">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 mt-1">
              Baseado em {marketExpenses.length} compras
            </p>
          </div>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 flex flex-col justify-between h-32">
          ...
          <div>
            ...
            <p className="text-[10px] text-zinc-500 mt-1">
              Você já usou <span className="text-amber-500">37%</span> da sua
              meta
            </p>
          </div>
        </div>
