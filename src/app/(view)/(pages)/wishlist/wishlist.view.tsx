...
import CreateWishlistItemForm from "./components/create-wishlist-item-form";
  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-5xl min-h-screen bg-black">
      <div className="flex flex-col space-y-10">
        ...
        <WishlistSummary items={initialItems} />
        ...
        <div className="space-y-6">
          ...
          <WishlistGrid items={initialItems} />
        </div>
      </div>

      {isFormOpen && (
        <CreateWishlistItemForm onClose={() => setIsFormOpen(false)} />
      )}
    </div>
  );
}
